...
path_input_cov = input("Enter path to covariates file (in .csv format):") # covariates to adjust for: age, tumor purity, disease subtype, the first 5 genotype PCs
no_factors = input("Enter number of PEER factors to include:") # In our case this was set to 3
